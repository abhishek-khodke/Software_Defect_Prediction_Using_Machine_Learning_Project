...
root.title("Efficient software defects predication using SVM  ")
#------------------Frame----------------------
...
lbl = tk.Label(root, text="Efficient software defects predication using SVM ", font=('times', 40,' bold '), height=1, width=50,bg="black",fg="white")
lbl.place(x=0, y=5)
